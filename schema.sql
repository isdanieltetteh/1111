...
CREATE TABLE `user_advertisements` (
  ...
  `duration_days` int(11) NOT NULL,
  `campaign_type` enum('standard','cpc','cpm') NOT NULL DEFAULT 'standard',
  `placement_type` enum('targeted','general') NOT NULL DEFAULT 'targeted',
  `target_width` int(11) DEFAULT NULL,
  `target_height` int(11) DEFAULT NULL,
  `budget_total` decimal(10,4) NOT NULL DEFAULT 0.0000,
  `budget_remaining` decimal(10,4) NOT NULL DEFAULT 0.0000,
  ...
  `status` enum('pending','active','paused','expired','rejected','completed') NOT NULL DEFAULT 'pending',
